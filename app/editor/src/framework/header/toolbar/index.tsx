  ...
  return (
    <div className={classes.toolbar}>
      <Tooltip placement="bottom" color="blue" title="撤销">
        <Button
          icon={<RemixIcon type="icon-arrow-go-back-fill" />}
          onClick={actions.history.undo}
        />
      </Tooltip>
      <Tooltip placement="bottom" title="恢复" color="blue">
        <Button
          icon={<RemixIcon type="icon-arrow-go-forward-fill" />}
      ...
      <JsEditor trigger={(
        ...
        <Button
          icon={<RemixIcon type="icon-braces-line" />}
          onClick={actions.history.redo}
        />
      </Tooltip>
      )} />
      ...
      >
        <Button
          danger
          icon={<RemixIcon type="icon-delete-bin-4-line" />}
